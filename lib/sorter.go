...
// Transfer will transfer files  after indexing according to action.
...
// NewSorter creates the sorter based on the WalkState generated by a scan and
// the method desired to sort.
//
